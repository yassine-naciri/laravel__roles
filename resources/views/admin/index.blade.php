...
<div class="text-gray-900 bg-gray-200">
    <div class="p-4 flex">
        <h1 class="text-3xl">Admin Pannel</h1>
    </div>
                ...
                <tr class="border-b hover:bg-orange-100 bg-gray-100">
                    ...
                    <td class="p-3 px-5">
                        <form method="POST" action="{{ url('/admin/update-role') }}" class="flex items-center">
                            ...
                            <button type="submit" class="text-sm bg-blue-500 hover:bg-green-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline">Save</button>
                        </form>
                    </td>
